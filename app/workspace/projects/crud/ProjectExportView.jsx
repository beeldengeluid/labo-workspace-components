...
const ProjectExportView = ({ recipe, params, user, clientId }) => {
  ...
  const handleCorpusSubmit = (e) => {
    ...
    let request_body = {
      request_text:
        "A user has requested access to the set " +
        set_id +
        " via the Media Suite",
      request_details: {
        ...
        "Collaborative Organisation":
          collaborativeOrganisationRef.current?.value,
  ...
  if (loading) {
    ...
    contents = (
      <div>
        ...
        <p>
          On this page you can export the metadata describing "{project.name}"
          or request to send your corpus, consisting of the metadata of the
          items in your bookmark groups and queries, to the SANE environment for
          analysis
        </p>
        <table>
          <tbody>
            <tr>
              <td>
                <label>Export project metadata - queries and annotations</label>
              </td>
              <td>
                <input
                  type="radio"
                  label="Export project metadata"
                  checked={exportType === "projectMetadata"}
                  value="projectMetadata"
                  onChange={() => setExportType("projectMetadata")}
                />
              </td>
            </tr>
            <tr>
              <td>
                <label>Export corpus to SANE</label>
              </td>
              <td>
                <input
                  type="radio"
                  label="Export corpus to SANE"
                  checked={exportType === "corpusToSane"}
                  value="corpusToSane"
                  onChange={() => setExportType("corpusToSane")}
                />
              </td>
            </tr>
          </tbody>
            ...
            >
              <div className="new-project-container">
                <span className="bg__new-project-wrapper">
                  <label className="label project-modal-left">
                    Name of export
                  </label>
                  <input
                    type="text"
                ...
                <span className="bg__new-project-wrapper">
                  <label className="label project-modal-left">
                    Name of person requesting data export
                  </label>
                  <input
                    type="text"
                    name="namePerson"
                ...
                <span className="bg__new-project-wrapper">
                  <label className="label project-modal-left">
                    SANE collaborative organisation
                  </label>
                  <input
                    type="text"
                    name="affiliation"
